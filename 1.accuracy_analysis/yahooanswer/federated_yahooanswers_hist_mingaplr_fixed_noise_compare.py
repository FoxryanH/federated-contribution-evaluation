...
CODE_VERSION = "yahooanswers_fixed_noise_hist_compare_v1"
DEFAULT_HIST_JSON = Path("outputs/yahooanswers_fixed_noise_hist_compare/results.json")
RATE_LABELS = {
    0.0: "clean",
    0.2: "noise20",
    0.4: "noise40",
...
class FixedLabelSubset(Dataset):
    ...
    def __getitem__(self, idx):
        features, _ = self.dataset[self.indices[idx]]
