...
import federated_cifar10_lcefl_mingaplr_S1_controlled_compare as s1_base


CODE_VERSION = "lcefl_controlled_compare_s2_v1"
DEFAULT_OUTPUT_JSON = Path("outputs/lcefl_controlled_compare/s2_results5.json")
...
def main():
    ...
    args = parse_args()
    s1_base.run_lcefl_experiment(args)
