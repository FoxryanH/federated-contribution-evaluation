...
import federated_cifar10_shapley_mingaplr_S1_controlled_compare as s1_base


CODE_VERSION = "shapley_controlled_compare_s2_default_v2"
DEFAULT_OUTPUT_JSON = Path("outputs/shapley_controlled_compare/s2_results.json")
...
def main():
    ...
    args = parse_args()
    s1_base.run_shapley_experiment(args)
