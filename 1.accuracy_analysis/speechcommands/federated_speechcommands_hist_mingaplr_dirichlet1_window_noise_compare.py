...
CODE_VERSION = "speechcommands_mingaplr_dirichlet1_window_noise_hist_compare_v1"
DEFAULT_HIST_JSON = Path("outputs/speechcommands_mingaplr_dirichlet1_fixed_noise_hist_compare/results.json")
