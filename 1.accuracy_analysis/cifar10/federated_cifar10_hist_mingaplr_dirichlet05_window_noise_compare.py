...
CODE_VERSION = "mingaplr_dirichlet05_window_noise_hist_compare_v6"
DEFAULT_HIST_JSON = Path("outputs/mingaplr_dirichlet05_fixed_noise_hist_compare/results17.json")
