...
import federated_cifar10_smartfl_mingaplr_dirichlet05_window_noise_compare as dirichlet05_base


CODE_VERSION = "mingaplr_dirichlet05_quality_perf_compare_v1"
DIRICHLET_ALPHA = 0.5
DEFAULT_OUTPUT_JSON = Path("outputs/mingaplr_dirichlet05_quality_perf_compare/results1.json")
...
def run_experiment(args):
    ...
    print(f"Quality performance compare JSON saved to: {output_path}")
